    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500 text-sm font-medium">Join us and start tracking your finances</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider ml-1">Full Name</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider ml-1">Password</label>
            <div className="relative group">
